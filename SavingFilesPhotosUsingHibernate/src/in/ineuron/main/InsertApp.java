...
public class InsertApp {
	...
	public static void main(String[] args) {
		...
		try (FileInputStream fis = new FileInputStream("D:/JAVA/HIBERNATE/12FEB2023/Hibernate_13_30PM/nitin.jpg")) {
			imageContent = new byte[(int) fis.available()];
			fis.read(imageContent);

			File f = new File("D:/JAVA/HIBERNATE/12FEB2023/Hibernate_13_30PM/resum.txt");
