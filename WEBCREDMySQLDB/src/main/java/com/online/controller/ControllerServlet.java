...
public class ControllerServlet extends HttpServlet {
	...
	private void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		if (requestURI.endsWith("searchform")) {
			...
			CustomerDetails custDetails=customerDetailController.findById(Integer.parseInt(sNumber));
			...
			if(custDetails != null) {
				...
				out.print("<tr><td>"+custDetails.getCustomerNo()+"</td> <td>"+custDetails.getCustomerName()+"</td> <td>"+custDetails.getCustomerAge()+"</td> <td>"+custDetails.getCustomerAddress()+"</td></tr>");
				out.print("</table>");
				out.print(" </body> </html>");
			}else {
